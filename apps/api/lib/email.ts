...
/**
 * Send an email using a Cloudflare Workers email binding.
 *
 * @param env Environment variables containing email configuration
 * @param options Email configuration
 */
export async function sendEmail(
  env: Pick<Env, "EMAIL_FROM" | "EMAIL_REPLY_TO"> & { MAILER: SendEmail },
...
export async function sendVerificationEmail(
  env: Pick<
    Env,
    "EMAIL_FROM" | "EMAIL_REPLY_TO" | "APP_NAME" | "APP_ORIGIN"
  > & { MAILER: SendEmail },
  options: {
...
export async function sendOTP(
  env: Pick<
    Env,
    "ENVIRONMENT" | "EMAIL_FROM" | "EMAIL_REPLY_TO" | "APP_NAME" | "APP_ORIGIN"
  > & { MAILER: SendEmail },
  options: {
    email: string;
    otp: string;
